...
%% }
\standard[shape=leaf,ni=1, no=1, nf=1, type=comb, moc=de]
(c) <5,.3> {};
\standard[shape=leaf,ni=1, nf=3, f1=ns, f2=od, f3=1, type=mealy, moc=sdf, at=c.south, anchor=north] (d) {p2};
%% \interface[mocin=sdf, mocout=sy]
%% 	  {e}{6.5,-2};
\drawing[ni=2, shape = zip shape, moc=sy, inner sep=20pt]
	{f}{9,-1.2};
%% \cluster[shape=leaf, moc=sy, type=MoCwrapper, inner sep=15pt]
%%         {c1}{(c)}{};
%% \cluster[shape=composite, ni=1, no=1, inner ysep=10pt]
%% 	{g}{(d)(e)}{composite1}; 
%% \cluster[shape=composite, ni=2, no=1, inner xsep=5pt]
%% 	{h}{(g)(c1)(f)}{composite2};
%% \cluster[ni=2, shape = dp shape, nf=1, type=farm1, inner sep=20pt] {i}{(h)}{pattern1};
