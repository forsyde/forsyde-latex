...
\begin{figure}[htb]\centering
  \begin{tikzpicture}[]
    \crossed[ni=1, no=1, shape=transition shape v1v1, type=evens, rotate=-45] (a) {};
    \crossed[ni=1, no=1, shape=transition shape v1v1, type=filter, rotate=45, nf=1, f1={$>0$} ] (b) <0,2> {};
    \standard[shape=leaf,ni=1, no=1, nf=1, type=comb, moc=de, left of=b, xshift=3cm] (c) {};
    \interface[left of=a, xshift=2cm](d1){sy}{sdf};
    \standard[shape=leaf,ni=1, nf=3, f1=ns, f2=od, f3=1, type=mealy, moc=sdf, left of=d1] (d) {p2};
    \interface[left of=d](e){sdf}{sy};
    \basic[shape=primitive, left of=c, nf=1, f1=i, xshift=1.5cm] (f) {$\Delta$};
    \standard[shape=leaf, ni=2, anchor=i2, xshift=2cm, f=$+$, moc=sy, type=comb] (g) <$(e)!.5!(f)$> {red};
    \cluster[shape=leaf, moc=sy, type=wrap, inner sep=15pt] (h) <(c)> {};
    \cluster[shape=composite, ni=1, no=1, inner ysep=13pt] (i) <(d1)(d)> {composite1}; 
    \cluster[shape=composite, ni=2, no=1, inner xsep=5pt] (j) <(g)(i)(h)> {composite2};
    \cluster[shape = dp shape, nf=2, f1={$\langle f \rangle$}, f2={$\langle 1 .. 1024 \rangle$},
      type=farm, inner sep=20pt] (k) <(j)> {pattern1};
    \crossed[shape=transition shape s1v1, rotate shape=180, type=zipx, left of=g, xshift=2cm] (l) {};
...
\standard[shape=leaf,ni=1, no=1, nf=1, type=comb, moc=sy]
	{c}{4,0}{p1};
