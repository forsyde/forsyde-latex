...
\ifnocolor \pgfsetfillcolor{\defaultfillcolor}%
\else \ifstrequal{#1}{sy}{\pgfsetfillcolor{sycolor}}{%
         \ifstrequal{#1}{de}{\pgfsetfillcolor{decolor}}{%
            \ifstrequal{#1}{ct}{\pgfsetfillcolor{ctcolor}}{%
                \ifstrequal{#1}{sdf}{\pgfsetfillcolor{sdfcolor}}{\pgfsetfillcolor{\defaultfillcolor}}}}}%
\fi
}
