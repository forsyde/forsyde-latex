...
\tikzset{
  ...
  sn/.style args = {#1}{getsignalmoc={#1}, line width=\signalpathlinewidth, >= stip, dashed, draw},
  v/.style args  = {#1}{getsignalmoc={#1}, line width=\vectorpathlinewidth, >= stip, draw},
  vn/.style args = {#1}{getsignalmoc={#1}, line width=\vectorpathlinewidth, >= stip, dashed, draw},
...
\cs_new_protected:Nn \davs__tokens_rec:n
 {
  \IfSubStr { #1 } { ( }{ 
    \pgfmathsetlength{\startFunc}{ \xTemp - \tokensize * \globScale } 
  }{}

  \davs__tokens_do:n { #1 } 

  \IfSubStr { #1 } { ) }{ 
    \pgfmathsetlength{\inTemp}{ \xTemp + \tokensize * \globScale }
    \draw[thin] (\startFunc,-\tokensize) rectangle (\inTemp,\tokensize); 
  }{}
