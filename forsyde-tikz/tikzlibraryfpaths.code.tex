...
\tikzset{
  ...
  s/.style args  = {#1}{getsignalmoc={#1}, line width=\signalpathlinewidth, >= stealth, draw},
  sn/.style args = {#1}{getsignalmoc={#1}, line width=.5,  >= stealth, double distance=1.3pt, draw},
%% v/.style args  = {#1}{getsignalmoc={#1}, line width=\vectorpathlinewidth, >= stip, draw},
%% vn/.style args = {#1}{getsignalmoc={#1}, line width=2, double distance=2pt, >= stip, double, draw},
%% f/.style       = {line width=\functionpathlinewidth, >= ftip, dotted, shorten >= 1mm, shorten <= 1mm, draw},
%% fn/.style       = {line width=.4, >= ftip, dotted, shorten >= 1mm, shorten <= 1mm, double distance=1pt, double, draw},
  srcport/.style={%
    shorten <=2pt,%
    decoration={%
      name=markings,
