...
\newcommand\makeioanchors[2]{
	...
	\xdef\portlist{} \foreach \i in {1,...,#1} {\pgfmathparse{1-\i*(1/(#1+.0003))+.5/(#1+.0003)} \xdef\portlist{\portlist \i/\pgfmathresult,}}
	\foreach \i/\n in \portlist {
		\xdef\doanchor{
			\noexpand\anchor{i\i}{
				\noexpand\northeast \noexpand\setlength{\noexpand\baz}{\noexpand\pgf@y}
	...
	\xdef\portlist{} \foreach \i in {1,...,#2} {\pgfmathparse{1-\i*(1/(#2+.0003))+.5/(#2+.0003)} \xdef\portlist{\portlist \i/\pgfmathresult,}}
	\foreach \i/\n in \portlist {
		\xdef\doanchor{
			\noexpand\anchor{o\i}{
				\noexpand\southwest \noexpand\setlength{\noexpand\baz}{\noexpand\pgf@y}
