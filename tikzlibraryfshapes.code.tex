...
\newcommand\makeioanchors[2]{
	...
	\xdef\portlist{} \foreach \i in {1,...,#1} {\pgfmathparse{1-\i*(1/(#1+1))} \xdef\portlist{\portlist \i/\pgfmathresult,}}
	\foreach \i/\n in \portlist {
		\xdef\doanchor{
			\noexpand\anchor{i\i}{
				\noexpand\northeast \noexpand\setlength{\noexpand\baz}{\noexpand\pgf@y}
	...
	\xdef\portlist{} \foreach \i in {1,...,#2} {\pgfmathparse{1-\i*(1/(#2+1))} \xdef\portlist{\portlist \i/\pgfmathresult,}}
	\foreach \i/\n in \portlist {
		\xdef\doanchor{
			\noexpand\anchor{o\i}{
				\noexpand\southwest \noexpand\setlength{\noexpand\baz}{\noexpand\pgf@y}
...
\newcommand\makefaanchors[1]{
	...
	\anchor{fa}{\faanchor} \anchor{f1}{\faif}
}
...
\newcommand\makefbanchors[1]{
	...
	\anchor{fb}{\fbanchor} \anchor{f2}{\fbif}
}
...
\newcommand\makefcanchors[1]{
	...
	\anchor{fc}{\fcanchor} \anchor{f3}{\fcif}
}
...
\newcommand\makefdanchors[1]{
	...
	\anchor{fd}{\fdanchor} \anchor{f4}{\fdif}
}
% draw function A
\newcommand\drawfa{
...
\pgfdeclareshape{domaininterface}{
	...
	%\anchor{i1}{\southwest\pgf@y=0pt} \anchor{o1}{\northeast\pgf@y=0pt}	
	\backgroundpath{%
		\northeast \pgf@xa=\pgf@x \pgf@ya=\pgf@y
		\southwest \pgf@xb=\pgf@x \pgf@yb=\pgf@y
		\pgfpathmoveto{\pgfpoint{\pgf@xa}{\pgf@ya}}   
...
\pgfdeclareshape{standardskeletonbox}{%
	\anchorsfromrectangle
	\savedanchor\northeast{\pgf@x=2pt\pgf@y=15pt}
	\savedanchor\centerpoint{\pgf@x=0pt\pgf@y=0pt}
	\savedanchor\southwest{\pgf@x=0pt\pgf@y=-15pt}
	\xdef\portlist{}
	\foreach \i in {0,...,7} {
