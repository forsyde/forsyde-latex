%% tikzlibraryforsyde.nodes.code.tex
...
\addcase\getmoclabel{syc}{SYC}
\addcase\getmoclabel{mrsy}{MRSY}
\addcase\getmoclabel{dt}{DT}
\addcase\getmoclabel{de}{DE}
\addcase\getmoclabel{re}{RE}
\addcase\getmoclabel{ct}{CT}
\addcase\getmoclabel{sdf}{SDF}
\addcase\getmoclabel{csdf}{CSDF}
\addcase\getmoclabel{sadf}{SADF}

\makeswitch[\defaultfillcolor]\getfieldcolor
\addcase\getfieldcolor{sy}{sycolor}
\addcase\getfieldcolor{syc}{sycolor}
\addcase\getfieldcolor{mrsy}{sycolor}
\addcase\getfieldcolor{dt}{decolor}
\addcase\getfieldcolor{de}{decolor}
\addcase\getfieldcolor{re}{decolor}
\addcase\getfieldcolor{ct}{ctcolor}
\addcase\getfieldcolor{sdf}{sdfcolor}
\addcase\getfieldcolor{csdf}{sdfcolor}
\addcase\getfieldcolor{sadf}{sdfcolor}
...
\newcommand{\makeconstructorlabel}[2]{%
  \IfStrEq{\constructorConvention}{atom}{%
    \typeStyle{\ifnolabel\else\getmoclabel{#1}.\fi#2}%
  }{%
    \typeStyle{#2\ifnolabel\else\getmoclabel{#1}\fi}%
  }
}
...
\NewDocumentCommand\standard{O{} D(){} D<>{0,0} m}{
  ...
  inner sep=0, outer sep=0,
    ...
    \begin{tikzpicture}
      ...
      (#2-t) at (#2-l.south){%
        \makeconstructorlabel{\fsdClass}{\fsdType}
      };
...
\NewDocumentCommand\interface{O{} O{} O{} D(){} D<>{0,0} m m}{
  \pgfkeys{/forsyde keys, default, #1}%
  \coordinate (globalPos) at (#5);
  \getcolor{/tikz/alwaystrue}{#6}{\fillcolorl}
  \getcolor{/tikz/alwaystrue}{#7}{\fillcolorr}
  \node[%
  ports e\fsdNPortLeft w\fsdNPortRight,
  anchor=\fsdAnchor,
  yshift=\fsdYShift,
  ...
  rotate=\fsdRotate,
  inner sep=0,
  ] (#4) at ($(globalPos) + (\fsdAtInit)$) {% 
    \begin{tikzpicture}
      \node[anchor=south east, inner sep=3pt] (#4-l) {%
        \typeStyle{\IfNoValueTF {#2}{\ifnolabel\else\getmoclabel{#6}\fi}{#2}}};
      \node[anchor=north west, inner sep=3pt] (#4-r) at (#4-l.south east) {%
        \typeStyle{\IfNoValueTF {#2}{\ifnolabel\else\getmoclabel{#7}\fi}{#3}}};
      \gettikzxy{(#4-l.north west)}{\xl}{\yl}
      \gettikzxy{(#4-r.south east)}{\xr}{\yr}
      \begin{pgfonlayer}{background}
