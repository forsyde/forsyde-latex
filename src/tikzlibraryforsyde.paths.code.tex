...
% also defined in forsyde.nodes, but we want to keep the libraries modular.
\newcommand\pathaddcase[3]{%
  \expandafter\def\csname\string#1@case@#2\endcsname{#3}%
}
\newcommand\pathmakeswitch[2][]{%
  \newcommand#2[1]{%
    \ifcsname\string#2@case@##1\endcsname\csname\string#2@case@##1\endcsname\else#1\fi%
  }%
}
% Case switch for drawing symbols
\pathmakeswitch[]\drawTokenSymbol
\pathaddcase\drawTokenSymbol{scalar}{\node[scalartokenshape, draw] at (\xTemp,0) {};}
\pathaddcase\drawTokenSymbol{vector}{\node[vectortokenshape, draw] at (\xTemp,0) {};}
\pathaddcase\drawTokenSymbol{function}{\node[functiontokenshape, draw] at (\xTemp,0){};}
