...
\pgfdeclareshape{stdcomm88box}{%
	\anchorsfromrectangle
	\savedanchor\northeast{\pgf@x=7pt\pgf@y=20pt}
	\savedanchor\centerpoint{\pgf@x=0pt\pgf@y=0pt}
	\savedanchor\southwest{\pgf@x=-7pt\pgf@y=-20pt}
	\makecomminnerbox{7}{7}
}
\pgfdeclareshape{stdcomm48box}{%
	\anchorsfromrectangle
	\savedanchor\northeast{\pgf@x=7pt\pgf@y=20pt}
	\savedanchor\centerpoint{\pgf@x=0pt\pgf@y=0pt}
	\savedanchor\southwest{\pgf@x=-7pt\pgf@y=-20pt}
	\makecomminnerbox{3}{7}
}
\pgfdeclareshape{stdcomm66box}{%
	\anchorsfromrectangle
	\savedanchor\northeast{\pgf@x=7pt\pgf@y=20pt}
	\savedanchor\centerpoint{\pgf@x=0pt\pgf@y=0pt}
	\savedanchor\southwest{\pgf@x=-7pt\pgf@y=-20pt}
	\makecomminnerbox{5}{5}
}

\pgfdeclareshape{vvbase}{%
	\anchorsfromrectangle
	\backgroundpath{%
...
\pgfdeclareshape{v2vbase}{%
	...
	\backgroundpath{%
		...
		\northeast \pgf@xa=\pgf@x \pgf@xb=\pgf@x \pgf@yb=\pgf@y
		\pgfpathmoveto{\pgfpoint{\pgf@xa}{\pgf@ya}}
		\pgfpathlineto{\pgfpoint{\pgf@xb}{-\sepq}}
		\pgfpathmoveto{\pgfpoint{\pgf@xa}{\sepq}}
		\pgfpathlineto{\pgfpoint{\pgf@xb}{\pgf@yb}}
		\pgfusepath{stroke}
	}        
}
\pgfdeclareshape{svbase}{%
	\anchorsfromrectangle
	\backgroundpath{%
		\pgfsetlinewidth{.5pt} 
		\northeast \pgf@ya=\pgf@y
