...
\begin{tikzpicture}[]
  ...
  \standard [process, nf=1, type=comb, moc=de, left of=b, xshift=3cm](c)           {};
  \interface[left of=a, xshift=2cm]                                (d1)            {sy}{sdf};
  \standard [process, f={ns;od;1}, type=mealy, moc=sdf, left of=d1](d)             {p2};
  ...
  \trans    [zipx, left of=g,xshift=2cm]                           (l)             {};
  ...
  \path (b.e1) edge[intersect=k-left, as=b-c1] (c) edge[intersect=h-left, as=b-c2] (c)
        (b-c1) edge[v]  (b.e1)  edge[s=sy,srcport]   (b-c2)
        (b-c2) edge[s=de,->]                         (c)
        (f)    edge[trans={<-,sn=sy}{h-right}{sn=de}](c)
               edge[sn=sy,-|-=.8,->]                 (g.w1)
        (a.e1) edge[trans={v,dstport}{k-left}{s,->}] (d1) 
        (d)    edge[<-, srcport, s]                  (d1)
               edge[s, srcport, ->]                  (e)
        (e)    edge[s,-|-,->]                        (g.w2)
        (g.e1) edge[intersect=k-right, as=g-l]       (l)
               edge[s]                               (g-l)
