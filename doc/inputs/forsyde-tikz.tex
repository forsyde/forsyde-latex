...
\end{figure}
\lstinputlisting{figs_src/example-forsyde-tikz.tex}
...
\lstinputlisting[linerange={5-5}]{figs_src/example-node-basic.tex}
...
\lstinputlisting[linerange={5-5}]{figs_src/example-node-standard.tex}
...
\lstinputlisting[linerange={5-5}]{figs_src/example-node-interface.tex}
...
\lstinputlisting[linerange={5-5}]{figs_src/example-node-trans.tex}
\caption{The \texttt{\char`\\trans} draw command. The function anchors are accessed with \texttt{[name]-f.[anchor]} and the port anchors are accessed with \texttt{[name].[anchor]}}
\end{figure}
...
\lstinputlisting[linerange={5-7}]{figs_src/example-node-cluster.tex}
...
\lstinputlisting[linerange={5-8}]{figs_src/example-node-drawconduit.tex}
...
\lstinputlisting[linerange={6-16}]{figs_src/example-paths.tex}
...
\lstinputlisting[linerange={5-6}]{figs_src/example-utility-portinfo.tex}
