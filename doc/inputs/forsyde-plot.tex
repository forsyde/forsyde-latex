...
\end{figure}
\lstinputlisting{figs_src/example-forsyde-plot.tex}
\newpage
...
\lstinputlisting[linerange={6-11}]{figs_src/example-signal-sy.tex}
...
\lstinputlisting[linerange={4-7,10-14}]{figs_src/example-signal-de.tex}
...
\lstinputlisting[linerange={5-19}]{figs_src/example-signal-ct.tex}
