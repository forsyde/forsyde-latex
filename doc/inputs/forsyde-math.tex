...
\begin{longtable} { c | c c c c c c c c c c }
  ...
  \midrule
  \texttt{PropCmb} & \makesymbolrow{\textProbCmb} \\
  \texttt{PropMap} & \makesymbolrow{\textProbMap} \\
  \texttt{PropTra} & \makesymbolrow{\textProbTra} \\
  \texttt{PropSam} & \makesymbolrow{\textProbSam} \\
  \bottomrule
\end{longtable}
