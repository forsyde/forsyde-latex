...
\begin{tikzpicture}[]
  \begin{signalsCT}[name=n, grid and time=1, xscale=.7, yscale=.7]{3.3}
    \signalCT [name=sig-ct1, outline, ymin=-1.1, ymax=2.1,draw ordinate, line style={ultra thick}]{
    ...
    \signalCT [name=sig-ct3, outline, ymin=-1.1, ymax=2.1,draw ordinate, line style={ultra thick}]{
