...
\lstset{
  ...
  moretexcs={trans,standard,interface,basic,cluster,node,path,embed,signalDE,signalCT,signal},
}
...
\blfootnote{This work is licensed under a \href{http://creativecommons.org/licenses/by-sa/4.0/}{Creative Commons Attribution-ShareAlike 4.0 International License}.}
\begin{abstract}
...
\newpage
\input{inputs/forsyde-math}
\newpage
\input{inputs/forsyde-plot}
\newpage
\input{inputs/forsyde-pictures}
\newpage
